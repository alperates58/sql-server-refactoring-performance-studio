...
async function scan(prefix = 'AA_', explicitScope = null) {
  ...
  const processedViews = allRawViews.map(v => {
    ...
    return {
      ...
      health: typeof health === 'object' && health !== null ? health.score : health,
      healthScore: typeof health === 'object' && health !== null ? health.score : health,
      healthBand: typeof health === 'object' && health !== null ? health.band : 'C',
      risk: riskCategory,
